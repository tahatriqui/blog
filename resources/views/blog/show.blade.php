    ...
    <div class="container m-auto pt-15 pb-5">
        ...
        @if (Auth::user() && Auth::user()->id === $post->user_id)
            <a href="/blog/{{ $post->slug }}/edit"
                class="bg-green-700
                    text-gray-100 py-4 px-5 mt-6
                    rounded-lg font-bold inline-block
                    uppercase text-l
                    place-self-start">
                Edit Post
            </a>
